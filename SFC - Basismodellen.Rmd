...
pension_ext <- sfcr_set(
  ...
  theta2 ~ 0.25,
  theta3 ~ 0.15,
  tau ~ 0.8, #Forbrugsudglattende. Når W og tau har samme størrelse (1). Tau er dog mindre end 1, hvorfor forbruget for pensionister ikke udglattes over livsperioden.
...
shock <- sfcr_shock(
  variables = sfcr_set(
    beta ~ 0.6 #arbejdsstyrkens andel falder fra 0,7 til 0,6
  ),
  start = 20,
  end = 100
)
