...
pension_eqs <- sfcr_set(
  ...
  #Adfærdsliginger
  Yd_b ~ W*N + r[-1]*Bb[-1] - T_b - Ss, 
  Yd_al ~ DP - T_al, 
  Yd_pen ~ FP + r[-1]*Bpen[-1] - T_pen, 
  ...
  #Skatter
  T_b ~ theta1 * (W*N+r[-1]*Bb[-1] - Ss), 
  T_al ~ theta2 * (DP), 
  T_pen ~ theta3 * (FP + r[-1]*Bpen[-1]),
  T ~ T_b + T_al+ T_pen,
...
SCENARIE 1: Stød foretages til beta-parameteren, der illustrerer arbejdsstyrkens andel af befolkningen, fra 0,75 til 0,65.
...
#Antallet af beskæftigede, arbejdsløse og pensionister
pc1_long %>%
